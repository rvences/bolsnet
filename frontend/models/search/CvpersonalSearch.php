...
class CvpersonalSearch extends Cvpersonal
{
    ...
    {
        return [
            [['id', 'estadocivil_id', 'entfed_id'], 'integer'],
            [['nombre', 'apaterno', 'amaterno', 'rfc', 'curp', 'fnac', 'sexo', 'tel_ofna', 'tel_ofna_ext', 'tel_movil', 'tel_casa', 'correo', 'municipio', 'colonia', 'cp', 'calle', 'numero', 'entrecalle', 'created_at', 'updated_at'], 'safe'],
        ];
    }
